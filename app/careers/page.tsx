    ...
    <main className="overflow-hidden">
      ...
      <section className="min-h-screen flex items-center justify-center pt-20 px-4 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Build the <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Future</span> With Us
          </motion.h1>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="space-y-4">
            {roles.map((role, index) => (
              ...
              >
                <button
                  onClick={() => setSelectedRole(selectedRole === role.id.toString() ? null : role.id.toString())}
                  className="w-full p-6 rounded-xl border border-border bg-card hover:border-primary/50 transition-all text-left"
                >
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-grow">
                      <div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-3">
                        <h3 className="text-xl font-bold text-foreground">{role.title}</h3>
                        <span className="w-fit px-3 py-1 text-xs font-medium rounded-full bg-accent/10 text-accent">
                          {role.department}
                        </span>
                      </div>
                ...
                {selectedRole === role.id.toString() && (
                  <motion.div
                    ...
                    className="mt-4 p-6 rounded-xl bg-muted border border-border"
                  >
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-6">
                      <div>
                        <h4 className="font-bold text-foreground mb-3">About This Role</h4>
                    ...
                    <Link
                      href={`/contact?subject=Job Application: ${role.title}`}
                      className="inline-flex px-6 py-2 rounded-lg bg-primary text-primary-foreground hover:bg-primary/90 transition-all font-medium gap-2"
                    >
                      Apply Now
                    </Link>
                  </motion.div>
